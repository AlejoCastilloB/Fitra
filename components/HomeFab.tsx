...
export default function HomeFab() {
  ...
  const items = [
    // El entreno vacío ya no está aquí: vive junto a "nueva rutina" en la pantalla de
    // entrenamiento, que es donde se busca cuando quieres arrancar algo.
    ...(inWorkout ? [] : [
  ...
  return (
    <>
      ...
      <div style={{ position: "fixed", right: 20, bottom: "calc(env(safe-area-inset-bottom, 0px) + 18px)", zIndex: 70, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 10 }}>
